# Graph Report - C:\Users\DELL\printing-shopdb\frontend  (2026-06-25)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 233 nodes · 411 edges · 19 communities (17 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34308fbd`
...
Cohesion: 0.10
Nodes (20): dependencies, autoprefixer, axios, clsx, framer-motion, fuse.js, html2pdf.js, html5-qrcode (+12 more)
...
- **Why does `formatCurrency()` connect `Community 2` to `Community 0`, `Community 3`, `Community 5`, `Community 7`?**
